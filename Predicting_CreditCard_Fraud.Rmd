...
```
## Original Data: Train Decision Tree, Naive Bayes, and LDA Models
...
## SMOTE Balanced Data: Train Decision Tree, Naive Bayes, and LDA Models
...
## ADASYN Balanced Data: Train Decision Tree, Naive Bayes, and LDA Models

Next, we will train the three classifier models using the ADASYN balanced training dataset. Again, to train the models, we can simply copy and paste the code we used to train the models in task 6, create new names for the model and change the data we are using to train our model to 'train.adas'
...
## DB-SMOTE Balanced Data: Train Decision Tree, Naive Bayes, and LDA Models

Next, we will train the three classifier models using the DB-SMOTE balanced training dataset. To train the models, we can simply copy and paste the code we used to train the models in task 7, create new names for the model and change the data we are using to train our model to 'train.dbsmote'
